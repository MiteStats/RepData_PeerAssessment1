...
### Reproducibe research Assignment 1
This is an R Markdown file for the 1st project of the Reproducible research course in Coursera. 


### Data analysis
In this project we are analysing the data of an individual´s fitbit data from between October and Novermber 2012 in order to divulge patterns of their activity during this period.
  
There are 17,568 observations over this period. Each observation has 3 variables 1) date of the measurement 2) no of steps 3) Identifier of the 5 minute interval in which the measurement was taken.
...
### Part 1- What is the mean total number of steps taken a day?
